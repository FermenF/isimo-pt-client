        ...
        <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            <div className="flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse h-10">
                    ...
                    <button type="button" onClick={ handleShowNavigate } className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                ...
                <div className={`${ !showNavigate ? 'hidden': 'block'} w-full md:block md:w-auto`} id="navbar-default">
